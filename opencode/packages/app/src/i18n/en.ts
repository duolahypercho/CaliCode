export const dict = {
  ...
  "prompt.placeholder.normal": 'What game do you want to build? "{{example}}"',
  "prompt.placeholder.simple": "What game do you want to build?",
  ...
  "prompt.example.1": "A neon snake game with power-ups",
  "prompt.example.2": "A space shooter where enemies dodge",
  "prompt.example.3": "Make my platformer double-jump",
