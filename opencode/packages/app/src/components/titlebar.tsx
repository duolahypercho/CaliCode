...
export function Titlebar(props: {
  ...
  // Chromeless keeps the titlebar's tab controller, commands and right-side
  // portal alive while hiding the visible tab bar — used when navigation lives
  // in the sidebar instead of a top bar.
  chromeless?: boolean
}) {
  ...
  return (
    <header
      ...
      classList={{
        ...
        "bg-v2-background-bg-deep": useV2Titlebar() && !props.chromeless,
        "bg-transparent": useV2Titlebar() && props.chromeless,
      ...
      style={{
        ...
        // In chromeless mode the sidebar owns that clearance, so drop it here.
        "padding-left": mac() && !props.chromeless ? `${84 / zoom()}px` : 0,
