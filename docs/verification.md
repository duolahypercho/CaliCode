...
- Model config and switching: `model_list` / `model_switch` verified live through the Codex Router gateway.
...
- Native subagents: Rust `subagent_spawn_runs_focused_agent` regression plus `scripts/agent-subagent-client.mjs` live coordinator/subagent/browser-tool roundtrip.
